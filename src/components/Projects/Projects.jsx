...
function Projects() {
    return (
        <div className="projects">
            ...
            <ProjectCard title={"Gamer Paradise"} tech={"React, Commerce.js, stripe"} description={"E-commerce Store"} img={gamerParadise} githubLink={"https://github.com/nathanspencerBenson/gamer-paradise"} />
            <ProjectCard title={"League of Legends"} tech={"React, HTML, SCSS"} description={"Gaming Platform"} img={"https://miro.medium.com/max/1838/1*3OPetZmlwDajdEBi3DQ1Rg.png"} flexOrder={1}/>
